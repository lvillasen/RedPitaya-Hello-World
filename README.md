...
- To see the signal you need an oscilloscope, or, arternatively, use the next project which generates an arbitrary signal on channel 1 of the fast DAC and acquires it with channel 1 of the fast ADC.
